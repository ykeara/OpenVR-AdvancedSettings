...
class MoveCenterTabController : public QObject {
    ...
    Q_PROPERTY(int tempRotation READ tempRotation WRITE setTempRotation NOTIFY tempRotationChanged)
    ...
    Q_PROPERTY(bool rotateHand READ rotateHand WRITE setRotateHand NOTIFY rotateHandChanged)
