...
namespace advsettings {
  ...
  void PttController::setPttControllerConfig(unsigned controller, QVariantList buttons, unsigned triggerMode, unsigned padMode, unsigned padAreas) {
  ...
  void PttController::startPtt() {
    m_pttActive = true;
    onPttStart();
    if (m_pttShowNotification && getNotificationOverlayHandle() != vr::k_ulOverlayHandleInvalid) {
